...
/* harmony default export */ var SwipeOutvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    _createHammer: function _createHammer() {
      ...
      this.hammer.add(pan);
      this.hammer.on('singletap', function (e) {
        return _this._singleTap(e);
      });
    ...
    _distanceSwiped: function _distanceSwiped() {
      ...
      var borderLeft = getComputedStyle(this.$el, null).getPropertyValue("border-left-width");
    ...
    _swipeListener: function _swipeListener(event) {
      ...
      if (this.startLeft === 0 && this.direction === 'ltr' && newX < 0) return this._animateSlide(-reduceSwipe(-newX)); // attempting to reveal the left actions after revealing the right actions

      if (this.startLeft === 0 && this.direction === 'rtl' && newX > 0) return this._animateSlide(reduceSwipe(newX)); // attempting to reveal the right actions after starting with the left actions revealed
    ...
    _stopListener: function _stopListener(event) {
      ...
      var oldLeft = this.$refs.content.getBoundingClientRect().left;
      this.isActive = false;
      this.$emit('active', false); // close left actions
      ...
      if (this.startLeft === 0 && this.direction === 'ltr' && currentLeft >= this.threshold) return this._animateSlide(this.leftActionsWidth, oldLeft); // reveal right actions

      if (this.startLeft === 0 && this.direction === 'rtl' && currentLeft <= -this.threshold) return this._animateSlide(-this.rightActionsWidth, oldLeft);
    ...
    _singleTap: function _singleTap(e) {
      if (this.disabled) return;
      this.$emit('swipeout:click', e);
    },
    _doubleTap: function _doubleTap(e) {
      if (this.disabled) return;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"cffca526-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/SwipeList.vue?vue&type=template&id=09e57740&
var SwipeListvue_type_template_id_09e57740_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"swipeout-list",class:{'swipeout--disabled': _vm.disabled}},[_vm._l((_vm.items),function(item,index){return _c('swipe-out',{key:item[_vm.transitionKey] || index,ref:("list-item-" + index),refInFor:true,staticClass:"swipeout-list-item",attrs:{"disabled":_vm.disabled,"threshold":_vm.threshold},on:{"active":function($event){_vm.$emit('active', $event)},"swipeout:click":function($event){_vm._emitClick($event, item, index)},"swipeout:dobuleclick":function($event){_vm._emitDblClick($event, item)},"swipeout:contentclick":function($event){_vm._contentClick($event, item)}},scopedSlots:_vm._u([{key:"left",fn:function(ref){
var close = ref.close;
return [_vm._t("left",null,{item:item,close:close})]}},{key:"default",fn:function(ref){
var close = ref.close;
...
var close = ref.close;
return [_vm._t("right",null,{item:item,close:close})]}}])})}),(!_vm.items.length)?[_vm._t("empty",[_vm._v("No results !")])]:_vm._e()],2)}
var SwipeListvue_type_template_id_09e57740_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/SwipeList.vue?vue&type=template&id=09e57740&
...
/* harmony default export */ var SwipeListvue_type_script_lang_js_ = ({
  ...
  methods: {
    _emitClick: function _emitClick(event, item) {
      this.$emit('swipeout:click', {
        event: event,
        item: item
      });
    },
    _emitDblClick: function _emitDblClick(event, item) {
      this.$emit('swipeout:doubleclick', {
        event: event,
        item: item
      });
    },
    _contentClick: function _contentClick(event, item) {
      this.$emit('swipeout:contentclick', {
        event: event,
        item: item
      });
    }
...
var SwipeList_component = normalizeComponent(
  ...
  SwipeListvue_type_template_id_09e57740_render,
  SwipeListvue_type_template_id_09e57740_staticRenderFns,
  false,
  null,
  null,
  null
